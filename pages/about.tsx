        ...
        <Container>
          <Row>
            <div className="about-content col-6">
              ...
              <p>I share my perspectives on things that are interesting <a href="/articles">here</a> and if you are looking for my resume, <a href={GOOGLE_DRIVE_RESUME} target="_blank">it's here ↗</a>.
              </p>
            </div>
          </Row>
        </Container>
