...
export const CMS_NAME = 'Karthik - Personal folio'
export const HOME_OG_IMAGE_URL =
  ...
  export const GOOGLE_DRIVE_RESUME = 'https://drive.google.com/file/d/17sBPw1cd76TRBgMFk8TEypX80b3lhnZv/view?usp=sharing'
