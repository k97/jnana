    ...
    <Container maxW="container.xl" pt={{ base: "0", sm: "0", md: 30 }} mt={{ base: -50, sm: -50, md: 0 }}>
      <Flex>
        <Box width={{ base: "100%", sm: "100%", md: "100%", lg: "100%", xl: "40%" }}>
          ...
          <Text fontSize={{ sm: "xl", md: "2xl" }} mt="5" mb="6">Design thinker based in Melbourne, who likes to code, create experiences that makes people’s lives better</Text>

          <Link href="/about">
            <Button colorScheme="brand" fontSize="xl" size="lg" shadow="xl" _hover={{ shadow: "sm", background: "brand.400" }} >More about me</Button>
          </Link>
          <Text fontSize={{ sm: "xl", md: "2xl" }} mt="6">See few of my selective <Link href="/work" ><a>work here</a></Link>, or If you want to read some interesting collation of my random <Link href="/articles"><a>thoughts here</a></Link>.</Text>
        </Box>
